...
// Deliverable 3:  Add a third tile layer
...
function getColor(magnitude) {
  if (magnitude > 6) {return "#ea2c2c";} // red
  if (magnitude > 5) {return "#ea822c";} // orange
  // if (magnitude > 4.5) {return "#ee9c00";}
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(plates).then((data) => {
    console.log(data);  
    L.geoJson(data, {
      // style plates with color and weight
